...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(KC_ESCAPE,KC_1,KC_2,KC_3,KC_4,KC_5,KC_LBRACKET,KC_GRAVE,KC_QUOTE,KC_COMMA,KC_DOT,KC_P,KC_Y,KC_DELETE,KC_EQUAL,KC_A,KC_O,KC_E,KC_U,KC_I,KC_TRANSPARENT,KC_SCOLON,KC_Q,KC_J,KC_K,KC_X,KC_LPRN,LT(1,KC_GRAVE),KC_TRANSPARENT,KC_TRANSPARENT,KC_LEFT,KC_RIGHT,ALT_T(KC_APPLICATION),KC_LGUI,ALT_T(KC_NO),SFT_T(KC_TAB),CTL_T(KC_BSPACE),KC_LGUI,KC_RBRACKET,KC_6,KC_7,KC_8,KC_9,KC_0,KC_EQUAL,KC_BSPACE,KC_F,KC_G,KC_C,KC_R,KC_L,KC_SLASH,KC_D,KC_H,KC_T,KC_N,KC_S,KC_MINUS,KC_RPRN,KC_B,KC_M,KC_W,KC_V,KC_Z,KC_BSLASH,KC_UP,KC_DOWN,KC_LCBR,KC_RCBR,MO(1),KC_LALT,CTL_T(KC_ESCAPE),KC_PGUP,KC_PGDOWN,ALT_T(KC_ENTER),KC_SPACE),
